...
<h4><p align="center">LAPORAN DATA SURAT PERINTAH PERJALANAN DINAS</p></h4>
<body>
<table border="1" align="center" class="table1">
    <tr>
        ...
        <?php $no = 1; foreach ($data as $key):?>
            ...
            <td><?php echo tgl_indo($key->tanggal_berangkat)?></td>
            <td><?php echo tgl_indo($key->tanggal_kembali)?></td>
