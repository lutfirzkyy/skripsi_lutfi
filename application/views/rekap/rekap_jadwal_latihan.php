...
<h4><p align="center">LAPORAN DATA JADWAL LATIHAN ATLIT</p></h4>
...
<table border="1" align="center" class="table1">
    <tr>
        ...
        <?php $no = 1; foreach ($data as $key):?>
            ...
            <td><?php echo $no++?></td>
            <td><?php echo $key->no_anggota ?></td>
            <td><?php echo $key->nama ?></td>
			<td><?php echo $key->cabang_olahraga?></td>
            <td><?php echo tgl_indo($key->tanggal_latihan)?></td>
            <td><?php echo $key->tempat_latihan ?></td>
            </tr>
            <?php endforeach ?>
    </table>
     <br><br>
