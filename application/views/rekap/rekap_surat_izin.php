...
<h4><p align="center">LAPORAN DATA SURAT IZIN</p></h4>
<body>
<table border="1" align="center" class="table1">
    <tr>
        ...
        <?php $no = 1; foreach ($data as $key):?>
            ...
            <!-- <td><?php echo tgl_indo($key->tanggal_terima)?></td> -->
            <td><?php echo $key->nik ?></td>
            <td><?php echo $key->nama ?></td>
            <td><?php echo $key->jabatan ?></td>
            <td><?php echo tgl_indo($key->tanggal_mulai_izin)?></td>
            <td><?php echo tgl_indo($key->tanggal_selesai_izin)?></td>
