...
<body>
  ...
  <img style="margin:0 auto; width: 100%;" src="<?php echo base_url('assets/kop.png')?>" alt="">
     ...
     Banjarmasin, <?php echo tgl_indo($data['tanggal_surat'])?>
      ...
      <div id="judul">SURAT PERINTAH PERJALANAN DINAS</div>
	  ...
	  echo $data['no_surat'];?></div>
   		...
   		<div class="isi">
		  <p>
		  Yang bertanda tangan dibawah ini Kepala Dinas Pemuda dan Olahraga Provinsi Kalimantan Selatan, Dengan ini memberi perintah dan tanggung jawab kepada :</p>
		  </div>
		...
		<table class="table">
		 ...
		 <div class="isi1">
		  <p>
		  Untuk melaksakan perjalanan dinas sebagai berikut :</p>
		  </div>
		  ...
		  <table class="table">
	 		<tbody>
 				...
 				<tr>
 					...
 					<td>:</td>
 					<td><?php echo tgl_indo($data['tanggal_kembali']);?></td>
                 </tr>            
 				<tr>
 					<td>Keperluan</td>
 					<td>:</td>
		 ...
		 <div class="isi1">
		 <p>
		 Demikian surat perintah perjalanan dinas ini dibuat agar dapat digunakan sebagaimana mestinya. Atas perhatiannya kami ucapkan terima kasih.
		 </p> 
		  </div>
