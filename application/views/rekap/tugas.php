  ...
  <img style="margin:0 auto; width: 100%;" src="<?php echo base_url('assets/kop.png')?>" alt="">
     ...
     Banjarmasin, <?php echo tgl_indo($data['tanggal_surat'])?>
	  ...
	  echo $data['no_surat'];?></div>
   		...
   		<div class="isi">
		  <p>
		  Yang bertanda tangan dibawah ini Kepala Dinas Pemuda dan Olahraga Provinsi Kalimantan Selatan, Dengan ini memberi tugas dan tanggung jawab kepada :</p>
		  </div>
		...
		<table class="table">
		 ...
		 <div class="isi1">
		  <p>
		  Untuk melaksakan tugas sebagai berikut :</p>
		  </div>
		 ...
		 <div class="isi1">
		 <p>
		 Demikian surat tugas ini dibuat agar dapat digunakan sebagaimana mestinya. Atas perhatiannya kami ucapkan terima kasih.
		 </p> 
		  </div>
