...
<head>
  ...
  <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url()?>assets/fantala.png">
    ...
    <link href="<?php echo base_url();?>assets/alert/sweetalert2.min.css" rel="stylesheet">
 	...
 	<script src="<?php echo base_url();?>assets/alert/sweetalert2.js"></script><!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
...
<style>
	...
	.text-themecolor {
		color: #b7720c !important;
	}

	.card-no-border > ul > li > a.active {
    	color: #ffffff;
    	background: #708090;
	}
	.sidebar-nav{
