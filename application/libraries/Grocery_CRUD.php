...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function _print_webpage($data)
	{
		...
		$header = base_url('assets/kop.png');
		echo "<center><img src='".$header."' width=100% ></center>";
		$string_to_print .="<br>";
		if(isset($_SESSION['CustomHeader']) && $_SESSION['CustomHeader']<>'') $string_to_print .="<u><h2 align='center';>" .$_SESSION['CustomHeader']."</h2></u>";
		...
		// $string_to_print .="<h4 align='right'>
		// 					Banjarmasin, 
		// 					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		// 					&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		// 					&nbsp; &nbsp; &nbsp;
		...
		// 					<br>
		// 					";
		// $string_to_print .= "<h3 align='right'>
		// 					<u>(--------------------------------)</u> &nbsp; &nbsp; &nbsp;";
		// $string_to_print .="</table>";  
